    ...
    <div className="w-full max-w-4xl mx-auto p-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Select a template that best fits your academic paper presentation
          needs
        </p>
      </div>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      ...
                      {template.id === "academic-project-page" &&
                        "JavaScript-based"}
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-blue-700">
                <p>
                  ...
                  {selectedTemplate.id === "academic-pages" &&
                    "Full Academic Site"}
                  {selectedTemplate.id === "academic-project-page" &&
                    "Project Showcase"}
                  {selectedTemplate.id === "al-folio" && "Minimal Portfolio"}
                </p>
                <p>
                  <span className="font-medium">Technology:</span>{" "}
                  {selectedTemplate.id.includes("academic-pages") ||
                  selectedTemplate.id.includes("al-folio")
                    ? "Jekyll (Ruby)"
                    : "JavaScript/HTML"}
                </p>
                <a
