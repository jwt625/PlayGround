    ...
    <div className="bg-white rounded-lg shadow-lg p-8 max-w-md mx-auto text-center">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Sign in with your GitHub account to create and manage your paper
          repositories
        </p>
      </div>
      ...
      <p className="text-xs text-gray-500 mt-4">
        We only request the minimum permissions needed to create repositories
        and deploy your sites. You can revoke access at any time in your GitHub
        settings.
      </p>
    </div>
  );
