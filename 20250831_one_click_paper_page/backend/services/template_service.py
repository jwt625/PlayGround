...
class TemplateService:
    ...
    def _initialize_templates(self) -> Dict[TemplateType, TemplateRepository]:
        ...
        return {
            TemplateType.ACADEMIC_PAGES: TemplateRepository(
                ...
                name="Academic Pages",
                description="A comprehensive academic website template with publications, talks, CV, and portfolio sections. Perfect for researchers and academics.",
            ...
            TemplateType.AL_FOLIO: TemplateRepository(
                ...
                name="Al-folio",
                description="A beautiful, simple, clean, and responsive Jekyll theme for academics. Features a clean design with support for publications, projects, and blog posts.",
            ...
            TemplateType.MINIMAL_ACADEMIC: TemplateRepository(
                ...
                description="A lightweight, fast-loading academic template focused on content. Ideal for single papers or simple academic pages.",
    ...
    def get_template_by_string_id(self, template_id: str) -> TemplateRepository:
        ...
        try:
            ...
            logger.warning(f"Unknown template ID: {template_id}, falling back to minimal-academic")
