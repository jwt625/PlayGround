...
c = gf.Component("chip2_iter12")

# Parameters - based on iteration 9 (75%) with targeted improvements
ring_radius = 10.0  # µm
ring_width = 0.5    # µm
coupling_gap = 0.25 # µm (changed from 0.20 per feedback)
ring_spacing = 13.0 # µm (kept from iteration 9)
bus_width = 0.5     # µm
...
# Slightly more than iteration 9 (9 rings) but less than iteration 10 (31 rings)
# 13 rings with 0.2 µm spacing
electrode_radii = [11.2, 11.0, 10.8, 10.6, 10.4, 10.2, 10.0, 9.8, 9.6, 9.4, 9.2, 9.0, 8.8]  # µm
electrode_width = 0.3  # µm (kept from iteration 9)
...
gc_spacing = 10.0  # changed from 8.0 per feedback
for i in range(2):
