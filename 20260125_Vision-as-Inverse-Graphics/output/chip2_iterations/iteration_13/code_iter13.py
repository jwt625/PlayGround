...
c = gf.Component("chip2_iter13")

# Parameters - EXACTLY iteration 9 except coupling_gap
ring_radius = 10.0  # µm
ring_width = 0.5    # µm
coupling_gap = 0.25 # µm (ONLY CHANGE from iteration 9: was 0.20)
...
# EXACTLY as iteration 9: 9 rings
electrode_radii = [11.0, 10.75, 10.5, 10.25, 10.0, 9.75, 9.5, 9.25, 9.0]  # µm
...
gc_spacing = 8.0  # EXACTLY as iteration 9
for i in range(2):
