...
c = gf.Component("chip2_iter09")

# Parameters from detailed analysis and verifier feedback
ring_radius = 10.0  # µm
ring_width = 0.5    # µm
coupling_gap = 0.20 # µm (reduced from 0.25 to get closer to target)
...
# Very tight spacing for better modulation efficiency
electrode_radii = [11.0, 10.75, 10.5, 10.25, 10.0, 9.75, 9.5, 9.25, 9.0]  # µm, many concentric rings
electrode_width = 0.3  # µm (narrower for tighter packing)
