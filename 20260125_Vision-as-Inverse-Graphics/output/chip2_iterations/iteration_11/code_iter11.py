...
c = gf.Component("chip2_iter11")

# Parameters - based on iteration 9 (75%) with refinements
ring_radius = 10.0  # µm
ring_width = 0.5    # µm
coupling_gap = 0.22 # µm (between 0.20 and 0.25)
ring_spacing = 12.5 # µm (slightly reduced from 13)
bus_width = 0.5     # µm
...
# Medium density - 15 rings with 0.2 µm spacing
electrode_radii = [11.2, 11.0, 10.8, 10.6, 10.4, 10.2, 10.0, 9.8, 9.6, 9.4, 9.2, 9.0, 8.8, 8.6, 8.4]  # µm
electrode_width = 0.25  # µm
