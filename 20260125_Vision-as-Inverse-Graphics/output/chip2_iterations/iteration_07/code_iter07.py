...
# Position rings so the gap between ring inner edge and bus top edge is exactly coupling_gap
rings = []
for i in range(3):
...
# Tighter gaps for better modulation efficiency
electrode_radii = [10.5, 10.0, 9.5, 9.0, 8.5]  # µm, multiple concentric rings
electrode_width = 0.5  # µm (narrower for tighter packing)
