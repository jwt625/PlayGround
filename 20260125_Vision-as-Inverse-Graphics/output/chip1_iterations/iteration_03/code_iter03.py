...
c = gf.Component("chip1_iter03")

# Iteration 3: Based on verifier feedback from iteration 2
# Verifier suggests returning to iteration 1 values
# - bend_radius: 72.5 µm (matches target range 70-75 µm)
# - straight_length: 22.5 µm (matches target range 20-25 µm)

# Parameters
bend_radius = 72.5  # µm (back to iter1 value, within target range)
straight_length = 22.5  # µm (back to iter1 value, within target range)
